                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Selamat Datang di Ayo Beli !</h1>
                                    </div>
                                    <form class="user">
                                        ...
                                        <a href="<?= $config['base_url'] ?>/dashboard" class="btn btn-primary btn-user btn-block">
                                            Login
                                        </a>
                                    </form>
                                    <hr>
                                    <div class="text-center">
                                        <a class="small" href="<?= $config['base_url'] ?>forgot-password">Forgot Password?</a>
                                    </div>
                                    <div class="text-center">
                                        <a class="small" href="<?= $config['base_url'] ?>register">Create an Account!</a>
                                    </div>
                                </div>
                            </div>
                        </div>
