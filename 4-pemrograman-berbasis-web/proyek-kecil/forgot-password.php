...
<body style="background-image: url('img/FPB1.jpg'); background-size: cover;">
            ...
            <div class="col-xl-10 col-lg-12 col-md-9">
                ...
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-block " style="background-image: url('img/FP3.png');background-size: cover"></div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user">
                                        ...
                                        <a href="<?= $config['base_url'] ?>login" class="btn btn-primary btn-user btn-block">
                                            Atur Ulang Kata Sandi
                                        </a>
                                    </form>
                                    <hr>
                                    <div class="text-center">
                                        <a class="small" href="<?= $config['base_url'] ?>register">Buat sebuah akun!</a>
                                    </div>
                                    <div class="text-center">
                                        <a class="small" href="<?= $config['base_url'] ?>login">Sudah memiliki akun? Login!</a>
                                    </div>
                                </div>
                            </div>
                        </div>
