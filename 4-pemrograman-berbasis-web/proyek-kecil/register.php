...
<head>
    ...
    <style>
        .bg-utama {
            background: radial-gradient(circle at top left, #22c1c3, #fdbb2d);
        }
    </style>
    ...
    <div class="container">
        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
            <div class="card-body p-0">
                ...
                <div class="row">
                    <div class="col-lg-5 d-none d-lg-block" style="background-image: url('img/FP3.png'); background-size: cover;"></div>
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <hr>
                            <div class="text-center">
                                <a class="small" href="<?= $config['base_url'] ?>login">Sudah punya akun? Login!</a>
                            </div>
                        </div>
                    </div>
                </div>
